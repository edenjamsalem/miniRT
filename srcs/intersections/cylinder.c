...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/14 11:15:35 by eamsalem          #+#    #+#             */
/*   Updated: 2025/03/14 11:31:58 by eamsalem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec3	get_normal(t_intsec *intsec, double t_top, double t_bottom, t_cy *cy)
{
	double	h;
...
void	get_cy_intsec_data(t_ray *ray, t_cy *cy, t_intsec *intsec)
{
	...
	if (intsec->t >= 0)
	{
		...
		intsec->normal = get_normal(intsec, t_top, t_bottom, cy);
		if (cy->camera_inside)
